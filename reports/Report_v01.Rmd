...
Cabe mencionar que los scripts del proyecto siguen una convención de codificación estricta para garantizar que el código sea legible y mantenible. Esto incluye el uso adecuado de comentarios, la nominación consistente de variables y funciones, y la estructuración lógica del código. En el repositorio de GitHub se encuntra alojado el código de cada script si se desea consultar.
